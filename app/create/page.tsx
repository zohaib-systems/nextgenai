...
// import { supabase } from "@/lib/supabase"; // removed unused client import

    // The following lines were unreachable after refactor and are removed
    // toast.success("Prompt published successfully!");
    // // Redirect – if we have the new id, use it; otherwise go to library
...
// Admin passcode – falls back to a hard‑coded dev default
...
export default function CreatePromptPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (passcode !== ADMIN_PASSCODE) {
      ...
      toast.error("Unauthorized: Invalid Admin Passcode");
      return;
    }
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="relative z-10">
          ...
          <p className="text-sm text-zinc-400 mt-1">
            Required to publish new prompts.
          </p>
        </div>
        <button
          type="submit"
